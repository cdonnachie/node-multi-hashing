...
extern "C" struct evrprogpow_epoch_context_full : evrprogpow_epoch_context
{
    ethash_hash1024* full_dataset;

    constexpr evrprogpow_epoch_context_full(int epoch, int light_num_items,
        const ethash::hash512* light, const uint32_t* l1, int dataset_num_items,
        ethash_hash1024* dataset) noexcept
      : evrprogpow_epoch_context{epoch, light_num_items, light, l1, dataset_num_items},
